...
use crate::window::{check_for_exit, initial_window, spawn_camera, update_active_window};
...
impl Plugin for EditorUiPlugin {
    fn build(&self, app: &mut App) {
        app
            .add_systems(PreStartup, (initial_window, setup_ui).chain())
            .add_systems(PreUpdate, (update_active_window, spawn_camera))
